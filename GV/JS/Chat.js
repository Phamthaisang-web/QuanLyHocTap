const users = JSON.parse(localStorage.getItem("users")) || {
  1: {
    ...
    messages: [
      { sender: "student", text: "Em xin lỗi thầy, em sẽ cố gắng hơn" },
      { sender: "teacher", text: "Thầy tin tưởng em, cố lên nha!" },
    ],
  },
  2: {
    name: "Nguyen Van B",
    ...
    messages: [
      { sender: "teacher", text: "Chào thầy, em cần hỗ trợ gì không?" },
      { sender: "student", text: "Dạ đồ án của em cần những gì ạ!" },
    ],
  },
};
